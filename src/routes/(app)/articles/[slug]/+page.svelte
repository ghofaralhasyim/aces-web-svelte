			...
			<div class="grid_column flex flex-row" data-col="s12,m12,l9">
				<div class="content-wrapper">
					<div class="flex flex-col">
						<p class="date">{Helpers.formatFullDate(data.dataArticle.updated_at)}</p>
						<span class="mr-8 category bg-blue">{data.dataArticle.category.name}</span>
					</div>
					...
					<div class="flex flex-col">
						{#each Array(5) as _, index (index)}
							<div class="related-article-card">
								...
								<p class="content">
									Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vel facilis voluptates
									sunt saepe soluta ut rerum, nihil cupiditate illum odit.
								</p>
							</div>
						{/each}
					</div>
